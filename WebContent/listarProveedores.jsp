  ...
  <div class="container-1">
      ...
      <input type="search" name="buscar" id="search" placeholder="Buscar..." autocomplete="off" />
        ...
        <table class="tabla">
      	...
      	ArrayList<ProveedorDTO> lista = (ArrayList<ProveedorDTO>) request.getAttribute("data");

			if (lista != null) {
		for (ProveedorDTO xProv : lista) {
			out.println("<tr>");
			out.println("<td>" + xProv.getCodProv() + "</td>");
			out.println("<td>" + xProv.getNombre() + "</td>");
			
			out.println("<td>" + xProv.getDireccion() + "</td>");
			out.println("<td>" + xProv.getCorreo() + "</td>");
			out.println("<td '> <span class='action_btn'><a href='ServletProveedor?tipo=buscar&cod=" + xProv.getCodProv() + "'>"
			+ "<i class='fa-sharp fa-solid fa-edit'></i></a><a href='ServletProveedor?tipo=eliminar&cod=" + xProv.getCodProv() + "'>"
