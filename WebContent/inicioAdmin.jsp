...
<html lang="en">
  ...
  <div class="header__admin">
        ...
        <nav class="navegacion">
          ...
          <option value="inicioUsuario.jsp" >Empleados </option>
                <option  value="productos"  >Productos</option>
                  <option  value="locales" >Locales</option>
                    <option  value=""  >Hola</option>

          </select>
          <a class="navegacion__enlace" href="index.jsp">Consultas</a>
          <a class="navegacion__enlace" href="nosotros.jsp">Reportes</a>
          <a class="navegacion__enlace" href="blog.jsp">Ventas</a>
