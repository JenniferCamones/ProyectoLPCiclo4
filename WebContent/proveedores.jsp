...
<html lang="en">
 ...
 <h2 class="__heading" id="titulo">Mantenimiento Proveedores</h2>
    ...
    <div class="mantenimiento__grid">
      ...
      <form action="ServletProveedor?tipo=agregar" method="post" class="formulario__crear">
        <div class="registrar__grid">
           <h3 class="__heading">Agregar Proveedor</h3>
    <div class="campo">

                <label for="codigo">Codigo:</label>
                <input type="text" name="txt_codigo" disabled="disabled"  placeholder="Codigo">
   ...
   <div class="campo">
                ...
                <input type="text" name="txt_correo"  placeholder="Correo">
      ...
      <form action="ServletProveedor?tipo=actualizar" method="post" class="formulario__crear">
        <div class="registrar__grid">
           <h3 class="__heading">Actualizar Proveedor</h3>
    <div class="campo">

                <label for="codigo">Codigo:</label>
                <input value="${requestScope.Proveedor.codProv}" type="text" name="txt_cod2" readonly="readonly"  placeholder="Codigo">
                ...
                <label for="nombre">Nombre:</label>
                <input value="${requestScope.Proveedor.nombre}" type="text" name="txt_nombre2"  placeholder="Nombre">

            </div>
   <div class="campo">

                <label for="direccion">Direccion:</label>
                <input value="${requestScope.Proveedor.direccion}" type="text" name="txt_direccion2"  placeholder="Direccion">
   ...
   <div class="campo">
                ...
                <label for="correo">Correo:</label>
                <input value="${requestScope.Proveedor.correo}" type="text" name="txt_correo2"  placeholder="Correo">
