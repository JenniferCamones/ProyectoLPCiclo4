...
rel="stylesheet">
  ...
  <div class="header__admin">
    ...
    <h2 class="__heading">Lista Empleados</h2>
  ...
  <div class="container-1">
      ...
      <input type="search" name="buscar" id="search" placeholder="Buscar..." autocomplete="off" />
        ...
        <table class="tabla">
      	...
      	ArrayList<EmpleadosDTO> lista = (ArrayList<EmpleadosDTO>) request.getAttribute("data");

			if (lista != null) {
		for (EmpleadosDTO xEmp : lista) {
			out.println("<tr>");
			out.println("<td>" + xEmp.getCodemp() + "</td>");
			out.println("<td>" + xEmp.getNombre() + "</td>");
			out.println("<td>" +xEmp.getApellido() + "</td>");
			out.println("<td>" + xEmp.getTelefono()+ "</td>");
			out.println("<td>" + xEmp.getDireccion() + "</td>");
			out.println("<td>" + xEmp.getCorreo() + "</td>");
			out.println("<td '> <span class='action_btn'><a href='ServletEmpleado?tipo=buscar&cod=" + xEmp.getCodemp() + "'>"
			+ "<i class='fa-sharp fa-solid fa-edit'></i></a><a href='ServletEmpleado?tipo=eliminar&cod=" + xEmp.getCodemp() + "'>"
