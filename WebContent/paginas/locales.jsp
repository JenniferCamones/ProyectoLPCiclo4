...
<div class="header__usuario">
              ...
              <a href="../login.jsp" class="boton-salir"> <i class="fa-sharp fa-solid fa-right-from-bracket"></i> Salir</a>
 ...
 <nav class="navegacion">
            ...
            <a class="navegacion__enlace active" href="../paginas/locales.jsp">Locales</a>
   ...
   <main class="__container">
    ...
    <div class="locales__grid">
      ...
      <div class="local">
            ...
            <div class="local__provincia">
        <h3  class="local__pronvincia-nombre">Lima</h3>
            </div>
            <div class="local__distrito">

                <h3 class="local__distrito-nombre">San Juan de Lurigancho</h3>

                <div class="local__distrito-info">

                    <div class="local__direccion">

                      <p>Av.CantoGrande</p>

                    </div>

                    <div class="local__telefono">
