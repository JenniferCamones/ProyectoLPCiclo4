    ...
    <h2 class="__heading">Consultas</h2>
      <div class="formulario-busqueda">
            ...
            <div class="opciones" style="margin-bottom: 2rem;">
              ...
              <a href="ServletCliente?tipo=listar">Clientes</a>
              <a href="ServletEmpleado?tipo=listar">Empleados</a>
              
              <a href="ServletProducto?tipo=listar">Productos</a>
              <a href="ServletLocal?tipo=listar">Locales</a>
              <a href="ServletProveedor?tipo=listar">Proveedores</a>
