...
<html lang="en">
        ...
        <div class="header__barra">
          ...
          <div class="header__derecho">
            ...
            <div class="header__login">
              <a class="header__login--opcion inicio" href="#">Iniciar Sesion</a>
              <a class="header__login--opcion boton" href="#">Crear Cuenta</a>
            </div>
          </div>
        </div>
 ...
 <a class="navegacion__enlace--mantenimiento" href="mantenimiento.html"><img class="mantenimiento__img" src="img/mantenimiento.png" alt=""></a>
   ...
   <main class="__container">
      <h2 class="__heading">Contenido de la pagina</h2>
